...
# TODO Need to make an ITEM_CATEGORY or something for DISK and other items
const COLOR_DEFAULTS: Dictionary = {
	"DISK": Color.CHARTREUSE
}

const ITEM_DEFAULTS: Dictionary = {
	"DISK": CONSTANTS.DISK_TYPE.FORCE
}
