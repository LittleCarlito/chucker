...
const CAMERA_DEFAULTS: Dictionary = {
	...
	"SHOT_WATCH_TIME": 5,
	CONSTANTS.PLAYER_FOCUS_OFFSET: Vector3(0, 2, -30),
	CONSTANTS.TEE_FOCUS_OFFSET: Vector3(0, 5, -60),
