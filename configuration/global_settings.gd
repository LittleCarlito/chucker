...
# Level configs
enum LEVEL_DEFAULTS {SPAWN_LOCATION}

const SALINAS_DEFAULTS: Dictionary = {
	LEVEL_DEFAULTS.SPAWN_LOCATION: Vector3(0, 1, 0)
}
...
const CONFIGURABLE_SETTINGS: Array[String] = [
	...
	CONSTANTS.USER_INPUT.FORWARD,
	CONSTANTS.USER_INPUT.BACKWARD,
	CONSTANTS.USER_INPUT.STRAFE_LEFT,
	CONSTANTS.USER_INPUT.STRAFE_RIGHT,
	CONSTANTS.USER_INPUT.JUMP,
	CONSTANTS.USER_INPUT.CROUCH,
	CONSTANTS.USER_INPUT.SPRINT,
	CONSTANTS.USER_INPUT.INTERACT,
	CONSTANTS.USER_INPUT.SCORE,
	CONSTANTS.USER_INPUT.PAUSE,
	CONSTANTS.USER_INPUT.DEBUG,
	CONSTANTS.USER_INPUT.PRIMARY,
	CONSTANTS.USER_INPUT.SECONDARY,
	CONSTANTS.USER_INPUT.ROTATE_UP,
	CONSTANTS.USER_INPUT.ROTATE_DOWN
]
