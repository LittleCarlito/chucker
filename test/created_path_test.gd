...
# TODO Draw example curve and examine its output
# TODO If exmaple curve is acceptable load it into PathDisk on ready along with variables so 30 ends up being the speed
# TODO Ensure prepare and engage are called and lauch that bastard
