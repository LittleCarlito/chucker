...
func _ready() -> void:
	...
	var path_disk_data: AssetData = AssetData.new(AssetData.TYPE.PATH, AssetData.ITEM_STATE.DISABLED, AssetData.CAMERA_STATE.TRACKABLE, AssetData.TYPE.FORCE, new_chuck.asset_data.group_name)
	var path_flight_data: FlightData = FlightData.new(15, test_transform.basis, test_path, false)
